...
export class AddColumnsToMessage1749471569893 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "message" DROP COLUMN "body"`);
        await queryRunner.query(`ALTER TABLE "message" ADD "message" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "message" ADD "readAt" TIMESTAMP`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "message" ADD "body" character varying NOT NULL`);
    }
