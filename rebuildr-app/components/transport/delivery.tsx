...
export const Delivery = ({ productId }: Props) => {
      ...
      <View style={{ gap: 24 }}>
        <View style={{ gap: 12 }}>
          ...
          <Body size="small" color="secondary">
            ...
            kostnader. Inbärning av produkten ingår endast om det har avtalats i
            förväg.
          </Body>
        </View>
        <Divider />
        ...
        {!isEditing && (
          <View style={{ gap: 12 }}>
            ...
            <Body size="small" color="secondary">
              ...
              ungefärligt område på kartan enligt nedan. Din adress visas först
