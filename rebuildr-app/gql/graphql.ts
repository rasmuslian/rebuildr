...
export type BuyProductDeliveryOptionQuery = { __typename?: 'Query', getDeliveryOption?: { __typename?: 'DeliveryOptionResponse', isWithinRadius: boolean, distanceFromProduct: number, deliveryPrice: number, postalCode: string, deliverToLocation: { __typename?: 'LocationResponse', lat: number, lng: number } } | null };
