...
export type Query = {
  ...
  internalAdsDashboardCsv: Scalars['String']['output'];
...
export type QueryInternalAdsDashboardCsvArgs = {
  input: InternalAdsDashboardInput;
};
...
export type InternalAdsDashboardCsvQueryVariables = Exact<{
  input: InternalAdsDashboardInput;
}>;


export type InternalAdsDashboardCsvQuery = { __typename?: 'Query', internalAdsDashboardCsv: string };
...
export const InternalAdsDashboardCsvDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"InternalAdsDashboardCsv"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"InternalAdsDashboardInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"internalAdsDashboardCsv"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<InternalAdsDashboardCsvQuery, InternalAdsDashboardCsvQueryVariables>;
