...
export type SinglePickupCreateFreePurchaseMutationVariables = Exact<{
  input: PurchaseProductInput;
}>;


export type SinglePickupCreateFreePurchaseMutation = { __typename?: 'Mutation', purchaseProduct: { __typename?: 'PurchaseProductResponse', purchase: { __typename?: 'Purchase', id: string, status: PurchaseStatusEnum } } };
...
export type SingleDeliveryCreateFreePurchaseMutationVariables = Exact<{
  input: PurchaseProductInput;
}>;


export type SingleDeliveryCreateFreePurchaseMutation = { __typename?: 'Mutation', purchaseProduct: { __typename?: 'PurchaseProductResponse', purchase: { __typename?: 'Purchase', id: string, status: PurchaseStatusEnum } } };
...
export const SinglePickupCreateFreePurchaseDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SinglePickupCreateFreePurchase"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PurchaseProductInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"purchaseProduct"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"purchase"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]}}]} as unknown as DocumentNode<SinglePickupCreateFreePurchaseMutation, SinglePickupCreateFreePurchaseMutationVariables>;
...
export const SingleDeliveryCreateFreePurchaseDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SingleDeliveryCreateFreePurchase"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"PurchaseProductInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"purchaseProduct"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"purchase"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]}}]} as unknown as DocumentNode<SingleDeliveryCreateFreePurchaseMutation, SingleDeliveryCreateFreePurchaseMutationVariables>;
