...
export type UpsertProductProductFragmentFragment = { __typename?: 'Product', id: string, title: string, description?: string | null, price: number, isGiveaway: boolean, condition: ProductConditionEnum, primaryQuantity?: number | null, primaryUnit?: QuantityUnitEnum | null, secondaryQuantity?: number | null, secondaryUnit?: QuantityUnitEnum | null, height?: number | null, heightUnit: MeasurementUnitEnum, width?: number | null, widthUnit: MeasurementUnitEnum, length?: number | null, lengthUnit: MeasurementUnitEnum, thickness?: number | null, thicknessUnit: MeasurementUnitEnum, diameter?: number | null, diameterUnit: MeasurementUnitEnum, weight?: number | null, weightUnit: MeasurementUnitEnum, color?: string | null, colorType: ColorTypeEnum, status: ProductStatusEnum, minimumPrice: number, noProject?: boolean | null, address?: string | null, pickupEnabled: boolean, deliveryRadius?: number | null, deliveryPrice?: number | null, deliveryEnabled: boolean, images: Array<{ __typename?: 'File', id: string, mimeType: string, url: string, name?: string | null }>, documents: Array<{ __typename?: 'File', id: string, mimeType: string, url: string, name?: string | null }>, category?: { __typename?: 'Category', id: string, name: string, hasChildren: boolean, ancestorIds: Array<string> } | null, brand?: { __typename?: 'Brand', id: string, type: BrandTypeEnum } | null, project?: { __typename?: 'Project', id: string } | null, location?: { __typename?: 'LocationResponse', lat: number, lng: number } | null, approximatePlace?: { __typename?: 'ApproximatePlaceResponse', lat: number, lng: number, address: string } | null, shippingPrices?: Array<{ __typename?: 'ShippingPrice', id: string, maxWeight: number, price: number, provider: ShippingProviderEnum }> | null };
