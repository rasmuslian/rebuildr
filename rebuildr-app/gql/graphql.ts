...
export type HubsQuery = { __typename?: 'Query', users: { __typename?: 'UsersResponse', total: number, users: Array<{ __typename?: 'User', id: string, username?: string | null, description?: string | null, websiteUrl?: string | null, profilePicture?: { __typename?: 'File', id: string, url: string } | null, projects: Array<{ __typename?: 'Project', id: string, title: string, approximatePlace: { __typename?: 'ApproximatePlaceResponse', lat: number, lng: number, address: string } }> }> } };
...
export type EditProjectQueryQuery = { __typename?: 'Query', getProject: { __typename?: 'Project', id: string, title: string, description?: string | null, contactName?: string | null, contactEmail?: string | null, contactPhone?: string | null, showDetailsOnMap: boolean, address: string, location: { __typename?: 'LocationResponse', lat: number, lng: number } } };
