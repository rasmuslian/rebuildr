...
export type SearchInSeasonQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, name: string, parentId?: string | null, children: Array<{ __typename?: 'Category', id: string }> }> };
