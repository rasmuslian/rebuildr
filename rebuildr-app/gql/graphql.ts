...
export type PartnersQuery = { __typename?: 'Query', partners: Array<{ __typename?: 'Partner', id: string, name: string, description: string, websiteUrl?: string | null, logo: { __typename?: 'File', id: string, url: string } }> };
