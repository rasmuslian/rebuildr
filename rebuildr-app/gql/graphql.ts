...
export type BuyProductTransportationOptionsQuery = { __typename?: 'Query', getPickupOption?: { __typename?: 'ApproximatePlaceResponse', lat: number, lng: number, address: string } | null, getShippingOptions: Array<{ __typename?: 'ShippingOptionResponse', shippingPrice: { __typename?: 'ShippingPrice', id: string, price: number }, servicePoints: Array<{ __typename?: 'ServicePointResponse', id: string, name: string, distance: number, streetName: string, streetNumber: string, postalCode: string, city: string }> }>, getDeliveryOption?: { __typename?: 'DeliveryOptionResponse', isWithinRadius: boolean, distanceFromProduct: number, deliveryPrice: number } | null };
...
export type PurchaseReceiptQuery = { __typename?: 'Query', purchase: { __typename?: 'Purchase', id: string, status: PurchaseStatusEnum, paymentAcceptedAt?: any | null, paymentMethod: PaymentMethod, transportationMethod: TransportationEnum, shippingPrice?: { __typename?: 'ShippingPrice', id: string, price: number, maxWeight: number, provider: ShippingProviderEnum } | null, product: { __typename?: 'Product', id: string, title: string, price: number, deliveryPrice?: number | null, seller: { __typename?: 'User', id: string, username?: string | null }, images: Array<{ __typename?: 'File', id: string, mimeType: string, url: string, name?: string | null }> }, buyer: { __typename?: 'User', id: string, username?: string | null, name?: string | null, address?: string | null, postCode?: string | null, city?: string | null, profilePicture?: { __typename?: 'File', id: string, url: string } | null } }, me: { __typename?: 'User', id: string, email?: string | null } };
