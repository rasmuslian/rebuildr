...
export type MutationMakeInternalAdPublicArgs = {
  productId: Scalars['String']['input'];
};
...
export type MakeInternalAdPublicMutationVariables = Exact<{
  productId: Scalars['String']['input'];
}>;


export type MakeInternalAdPublicMutation = { __typename?: 'Mutation', makeInternalAdPublic: { __typename?: 'Product', id: string, publiclyAvailable: boolean } };
...
export type ProductListQuery = { __typename?: 'Query', products: { __typename?: 'ProductsResponse', total: number, products: Array<{ __typename?: 'Product', id: string, status: ProductStatusEnum, title: string, price: number, soldByQuantity: boolean, condition: ProductConditionEnum, primaryQuantity?: number | null, primaryUnit?: QuantityUnitEnum | null, likedByMe?: boolean | null, primaryImage?: { __typename?: 'File', id: string, url: string } | null, approximatePlace?: { __typename?: 'ApproximatePlaceResponse', address: string } | null, seller: { __typename?: 'User', id: string, rating?: number | null, type: UserType } }> }, me: { __typename?: 'User', id: string } };
...
export const MakeInternalAdPublicDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MakeInternalAdPublic"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"makeInternalAdPublic"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"productId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"publiclyAvailable"}}]}}]}}]} as unknown as DocumentNode<MakeInternalAdPublicMutation, MakeInternalAdPublicMutationVariables>;
