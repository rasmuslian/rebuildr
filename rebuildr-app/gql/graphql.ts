...
export type BuyProductDeliveryOptionQuery = { __typename?: 'Query', getDeliveryOption?: { __typename?: 'DeliveryOptionResponse', isWithinRadius: boolean, distanceFromProduct: number, deliveryPrice: number } | null };
