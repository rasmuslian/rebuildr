...
export type TrendingNowProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductsResponse', total: number, products: Array<{ __typename?: 'Product', id: string, title: string, status: ProductStatusEnum, likedByMe?: boolean | null, primaryQuantity?: number | null, primaryUnit?: QuantityUnitEnum | null, condition: ProductConditionEnum, price: number, primaryImage?: { __typename?: 'File', id: string, url: string } | null }> } };
